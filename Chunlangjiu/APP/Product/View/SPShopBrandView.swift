...
import UIKit
import SnapKit
typealias SPShopBrandComplete = (_ model : SPBrandModel?)->Void
class SPShopBrandView : UIView{
    ...
    var selectBlock : SPShopBrandComplete?
...
extension SPShopBrandView : UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let shopBrandCellID = "shopBrandCellID"
        ...
        if indexPath.row < sp_getArrayCount(array: self.dataArray) {
            ...
            cell?.textLabel?.text = sp_getString(string: model?.brand_name)
            if model?.brand_id == selectBrandID {
