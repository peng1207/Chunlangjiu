...
import UIKit
import SnapKit
typealias SPShopTypeComplete = (_ model : SPTypeModel?)->Void
class SPShopTypeView : UIView{
    ...
    var selectBlock : SPShopTypeComplete?
...
extension SPShopTypeView : UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let shopBrandCellID = "ShopTypeCellID"
        ...
        if indexPath.row < sp_getArrayCount(array: self.dataArray) {
            ...
            cell?.textLabel?.text = sp_getString(string: model?.odor_name)
            if model?.odor_id == selectBrandID {
